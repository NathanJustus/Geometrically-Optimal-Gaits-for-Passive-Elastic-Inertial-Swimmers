%Given a sysplotter .mat file with the inertial structure 's', generates
%interpolant fits for metric, coriolis, and connection matrices as function
%of swimmer shape

clear all;
load('ClothoidInertialStructure.mat');
...
%Clear unneeded variables and save as new data file
clearvars -except funs s
save('ClothoidMetricCoriolis.mat');
